...
import type { BaseInMemoryEntitySchema, FormationEnergyPropertySchema } from "@mat3ra/esse/dist/js/types";
export type FormationEnergyPropertySchemaMixin = Omit<FormationEnergyPropertySchema, "_id" | "slug" | "systemName" | "schemaVersion">;
export type FormationEnergyPropertyInMemoryEntity = InMemoryEntity<BaseInMemoryEntitySchema & FormationEnergyPropertySchemaMixin>;
