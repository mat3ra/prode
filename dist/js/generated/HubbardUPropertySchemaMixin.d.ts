...
import type { BaseInMemoryEntitySchema, HubbardUParametersPropertySchema } from "@mat3ra/esse/dist/js/types";
export type HubbardUPropertySchemaMixin = Omit<HubbardUParametersPropertySchema, "_id" | "slug" | "systemName" | "schemaVersion">;
export type HubbardUPropertyInMemoryEntity = InMemoryEntity<BaseInMemoryEntitySchema & HubbardUPropertySchemaMixin>;
