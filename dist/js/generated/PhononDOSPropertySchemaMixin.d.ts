...
import type { BaseInMemoryEntitySchema, PhononDensityOfStatesPropertySchema } from "@mat3ra/esse/dist/js/types";
export type PhononDOSPropertySchemaMixin = Omit<PhononDensityOfStatesPropertySchema, "_id" | "slug" | "systemName" | "schemaVersion">;
export type PhononDOSPropertyInMemoryEntity = InMemoryEntity<BaseInMemoryEntitySchema & PhononDOSPropertySchemaMixin>;
